                    ...
                    ? [
                          {
                              ...
                              end_at: start + 60,
                              speaker: 'alex',
                              text: `Opening remarks for meeting ${i}`,
                              created_at: start + 61,
                              sync_state: 'clean',
                          },
                          {
                              ...
                              end_at: start + 180,
                              speaker: 'sam',
                              text: 'Discussion about roadmap and priorities',
                    ...
                    ? [
                          {
                              ...
                              sent_at: start + 10,
                              role: 'user',
                              content: `How do I structure feature ${i}?`,
                              created_at: start + 10,
                              sync_state: 'clean',
                          },
                          {
                              ...
                              sent_at: start + 12,
                              role: 'assistant',
                              content: 'Consider splitting into small components and testing them independently.',
                              created_at: start + 12,
                              sync_state: 'clean',
                          },
                      ]
